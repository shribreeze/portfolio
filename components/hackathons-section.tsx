...
const hackathons = [
  ...
  },
  {
    ...
    position: "Winner",
    prize: "$150",
    project: "StartupBazaar, FundBowl, EstateBid",
    description: "Built 3 embeddable apps solving real-world problems on Andromeda Operating System using ADOs like marketplace, auction, crowdfund and spliter.",
    tech: ["aOS", "ADOs", "Marketplace", "Auction", "Crowdfund"],
    demo: "#",
    logo: "/placeholder.svg?height=80&width=80",
    category: "Web3",
