                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <motion.a
                      ...
                      className="flex items-center space-x-4 p-4 rounded-xl hover:bg-white/5 transition-colors cursor-pointer group w-full overflow-hidden"
                      whileHover={{ x: 10 }}
                    >
                      <div className="text-cyan-400 group-hover:text-cyan-300 transition-colors">{info.icon}</div>
                      <div className="min-w-0">
                        <div className="text-gray-400 text-sm">{info.label}</div>
                        <div className="text-white font-semibold break-words">{info.value}</div>
                      </div>
                    </motion.a>
                  ))}
                </div>
